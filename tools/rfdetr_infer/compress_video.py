...
def compress_mp4(
    ...
    *,
    ...
    """Re-encode with libx264. Default CRF 23 is a good size/quality tradeoff for Drive."""
    src = Path(src)
    if not src.is_file():
...
def build_parser() -> argparse.ArgumentParser:
    ...
    p.add_argument("--crf", type=int, default=23, help="Lower=better quality/larger (23 ≈ Drive-friendly)")
